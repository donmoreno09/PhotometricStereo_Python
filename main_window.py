...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.config = {
            ...
            "black_error_v": "",
            "black_error_v2": "",
            "light_strenght_file_path": "assets/lightStrenght.txt",
            'input_images': [],
            #'working_directory': '',
            'output_directory': '',
            'all_lights_on_image': '',
            'light_direction_images': None,
            'normal_map': None,
            'depth_map': None,
            'albedo': None
        }
    ...
    def create_input_tab(self):
        ...
        self.select_sphere_button = QPushButton("Select Light Direction Images...")
        self.select_sphere_button.clicked.connect(self.select_light_direction_images)
        light_layout.addWidget(self.select_sphere_button)

        #VALUTARE SE INSERIRE LA PREVIEW!!!
    ...
    def setup_changed(self):
        ...
        if setup == "Vertical":
            self.config["lights_file_path"] = "assets/Default_Vertical.txt"
            self.config["black_error_v"] = "assets/Black_Error_Vertical.tif"
            self.config["black_error_v2"] = "assets/Black_Error_Vertical_2.tif"
        else:
            self.config["lights_file_path"] = "assets/Default_Horizontal.txt"
            self.config["black_error_h"] = "assets/Black_Error_Horizontal.tif"
            self.config["black_error_h2"] = "assets/Black_Error_Horizontal_2.tif"
        #self.console_output.setText(f"Setup changed to: {setup}")
        #VALUTARE DI CREARE create_console
    
    #CAMBIARE INPUT! -> immettere file
